...
function checkWinner(){
    if (score.userScore == 5) {
        confetti.start()
		Array.from(document.getElementsByClassName(`container`))[0].classList.add(`displayNone`)
		document.getElementById(`won`).style.display = 'block'
		document.getElementById(`wonMess`).innerHTML += `<p class= 'bold'>Score: You ${score.userScore} Robo ${score.roboScore}</p> `

    } else if (score.roboScore == 5) {
		Array.from(document.getElementsByClassName(`container`))[0].classList.add(`displayNone`)
		document.getElementById(`lost`).style.display = 'block'
		document.getElementById(`lostMess`).innerHTML += `<p class= 'bold'>Score: You ${score.userScore} Robo ${score.roboScore}</p> `
    }
}

function playAgain(){
	Array.from(document.getElementsByClassName(`container`))[0].classList.remove(`displayNone`)
	document.getElementById(`won`).style.display = 'none'
	document.getElementById(`lost`).style.display = 'none'
	document.getElementById(`wonMess`).innerHTML = ``
	document.getElementById(`lostMess`).innerHTML = ``
	reset();
	confetti.stop()
}
